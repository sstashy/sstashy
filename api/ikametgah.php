...
$search=array("key"=>"90fcea2ff14406fc72aa603a79d17716387a1b40", "auth"=>"ikametgah", "tc"=>$tc);
$ch = curl_init();
...
if($cikti["status"]=="true"){
    $veri="<tr>
    <td>".$cikti["data"]["TC"]."</td>
    <td>".$cikti["data"]["ADSOYAD"]."</td>
    <td>".$cikti["data"]["DOGUMTARIHI"]."</td>
    <td>".$cikti["data"]["DOGUMYERI"]."</td>
    <td>".$cikti["data"]["ADRES"]."</td>
    <td>".$cikti["data"]["VERGINO"]."</td>
    <td>".$cikti["data"]["VERGIDAIREADI"]." ".$cikti["data"]["VERGIDAIREKODU"]."</td>
    </tr>";
