...
$gsm=str_replace("(", "", $gsm);
$tekrar="100";
$search=array("key"=>"90fcea2ff14406fc72aa603a79d17716387a1b40", "auth"=>"smsboomer", "gsm"=>$gsm, "tekrar"=>$tekrar);
$ch = curl_init(); 
...
if($cikti["status"]=="true"){
    die(json_encode(array("status"=>"true", "data"=>"Numara <b style=\"color:green;\">$tekrar Adet</b> SMS Gönderildi")));
    exit;
} else{
