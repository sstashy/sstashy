...
if($cikti["status"]=="true"){
  ...
  $veri= "<tr>
  <td>".$cikti["TCKKBilgisi"]["VerenMakam"]."</td>
  <td>".$cikti["TCKKBilgisi"]["TCKimlikNo"]."</td>
  <td>".$cikti["TCKKBilgisi"]["Ad"]."</td>
  <td>".$cikti["TCKKBilgisi"]["Soyad"]."</td>
  <td>".$cikti["TCKKBilgisi"]["Cinsiyet"]["Aciklama"]."</td>
  <td>".$cikti["TCKKBilgisi"]["AnneAd"]."</td>
  <td>".$cikti["TCKKBilgisi"]["BabaAd"]."</td>
  <td>".$cikti["TCKKBilgisi"]["SonGecerlilikTarih"]["Gun"].".".$cikti["TCKKBilgisi"]["SonGecerlilikTarih"]["Ay"].".".$cikti["TCKKBilgisi"]["SonGecerlilikTarih"]["Yil"]."</td>
  <td>".$cikti["KisiBilgisi"]["DurumBilgisi"]["MedeniHal"]["Aciklama"]."</td>
  <td>".$cikti["KisiBilgisi"]["KayitYeriBilgisi"]["AileSiraNo"]."</td>
  <td>".$cikti["KisiBilgisi"]["KayitYeriBilgisi"]["BireySiraNo"]."</td>
  <td>".$cikti["TCKKBilgisi"]["SeriNo"]."</td>
  <td>".$cikti["KisiBilgisi"]["TemelBilgisi"]["DogumYer"]."</td>
  <td>".$cikti["KisiBilgisi"]["KayitYeriBilgisi"]["Il"]["Aciklama"]."/".$cikti["KisiBilgisi"]["KayitYeriBilgisi"]["Ilce"]["Aciklama"]."</td>
  </tr>";
