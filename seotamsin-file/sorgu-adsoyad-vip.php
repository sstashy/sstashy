                    ...
                    <div class="col-xl-12 max-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p style="margin-bottom:3rem;">İsim Soyisim Girmeniz Zorunludur!</p>
                                <div class="col-xl-12 max-auto" style="text-align:center;">
                                    ...
                                    <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                            ...
                                            <input type="text" id="anne" class="form-control"
                                                placeholder="Kişinin Annesinin Adını Giriniz...">
                                        </div>
                                    </div>
                                    <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                                id="basic-addon1">Anne TC</span>
                                            <input type="text" id="annetc" class="form-control"
                                                placeholder="Kişinin Annesinin TC numarasını Giriniz...">
                                        </div>
                                    </div>
                                     <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                                id="basic-addon1">Baba Adı</span>
                                            <input type="text" id="baba" class="form-control"
                                                placeholder="Kişinin Babasının Adını Giriniz...">
                                        </div>
                                    </div>
                                    <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                                id="basic-addon1">Baba TC</span>
                                            <input type="text" id="babatc" class="form-control"
                                                placeholder="Kişinin Babasının TC numarasını Giriniz...">
                                        </div>
                                    </div>
                                    <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                                id="basic-addon1">Uyruk</span>
                                            <input type="text" id="uyruk" class="form-control"
