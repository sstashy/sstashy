        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <style>
                        #vesika-img{
                            background:#fff;padding:10px;border-radius:10px;width:150px;
                        }
                    </style>
                    <div class="col-xl-12" style="text-align:center;margin-bottom:30px;">
                                <img src="assets/images/users.png" id="vesika-img">
                    </div>
                    <div class="col-xl-12 max-auto">
                        <div class="card">
                            <div class="card-body">
        ...
        $('#search').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#vesika-img").attr("src", "data:image/jpeg;base64," + json.vesika);
                    $("#vesika-img").css("padding","0px");
