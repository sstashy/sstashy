                    ...
                    <div class="col-xl-12 max-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p style="margin-bottom:3rem;">Zemin NO Girmeniz Zorunludur!</p>
                                <div class="col-xl-12 max-auto" style="text-align:center;">
                                    <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                                id="basic-addon1">Zemin NO:</span>
                                            <input type="text" id="zeminid" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
