                    ...
                    <div class="col-xl-12 max-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p style="margin-bottom:3rem;">GSM Girmeniz Zorunludur!</p>
                                <div class="col-xl-12 max-auto" style="text-align:center;">
                                    <div class="col-xl-12" style="display:inline-block">
                                        <div class="input-group mb-3"> <span class="input-group-text"
                                                id="basic-addon1">GSM:</span>
                                            <input type="text" id="gsm" data-mask="(599) 999 9999" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-xl-12">
...
<table id="example5" class="table table-striped table-bordered">
                                                    <tbody id="veri" style="text-align:center;">
                                                        <tr role="row" class="odd">
                                                            <td colspan="20">İşlem Bitene Kadar Sayfayı Kapatmayın.</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
